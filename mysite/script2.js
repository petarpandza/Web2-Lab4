(function () {
    ...
    u("Promise", function (a) {
        ...
        e.prototype.Ha = function (g) {
            if (g === this)
                this.Z(new TypeError("A Promise cannot resolve to itself"));
        ...
        e.prototype.ua = function (g, k) {
            if (this.F != 0)
                throw Error("Cannot settle(" + g + ", " + k + "): Promise already settled in state" + this.F);
            this.F = g;
            this.K = k;
            this.F === 2 && this.Ia();
            this.Da()
        ...
        e.prototype.Ia = function () {
            ...
            d(function () {
                if (g.Fa()) {
                    var k = r.console;
                    typeof k !== "undefined" && k.error(g.K)
                }
            }, 1)
        }
            ;
        e.prototype.Fa = function () {
            ...
            typeof g === "function" ? g = new g("unhandledrejection", {
                ...
                cancelable: !0
            }) : (g = r.document.createEvent("CustomEvent"),
    ...
    u("Map", function (a) {
        if (function () {
            ...
            try {
                ...
                var l = h.entries()
                    , m = l.next();
                if (m.done || m.value[0] != k || m.value[1] != "s")
                    return !1;
                m = l.next();
        ...
        c.prototype.delete = function (k) {
            k = d(this, k);
            return k.i && k.list ? (k.list.splice(k.index, 1),
        ...
        c.prototype.forEach = function (k, h) {
            for (var l = this.entries(), m; !(m = l.next()).done;)
                m = m.value,
                    k.call(h, m[1], m[0], this)
        }
            ;
        c.prototype[Symbol.iterator] = c.prototype.entries;
        var d = function (k, h) {
            var l = h && typeof h;
            l == "object" || l == "function" ? b.has(h) ? l = b.get(h) : (l = "" + ++g,
                b.set(h, l)) : l = "p_" + h;
            var m = k[0][l];
            if (m && z(k[0], l))
...
*/
    ...
    function Qa() {
        var a = Ra;
        if (!Array.isArray(a) || !Array.isArray(a.raw) || a.length !== a.raw.length || !Oa && a === a.raw || !(Oa && !Pa || Ma(a)) || 1 !== a.length)
            throw new TypeError("\n    ############################## ERROR ##############################\n\n    It looks like you are trying to call a template tag function (fn`...`)\n    using the normal function syntax (fn(...)), which is not supported.\n\n    The functions in the safevalues library are not designed to be called\n    like normal functions, and doing so invalidates the security guarantees\n    that safevalues provides.\n\n    If you are stuck and not sure how to proceed, please reach out to us\n    instead through:\n     - go/ise-hardening-yaqs (preferred) // LINE-INTERNAL\n     - g/ise-hardening // LINE-INTERNAL\n     - https://github.com/google/safevalues/issues\n\n    ############################## ERROR ##############################");
        var b = a[0].toLowerCase();
        if (b.indexOf("on") === 0 || "on".indexOf(b) === 0)
    ...
    ; var Sa = globalThis.trustedTypes, Ta;
    function Ua() {
        var a = null;
        if (!Sa)
            return a;
    ...
    ; function ab(a) {
        ...
        if (b.map(function (c) {
            if (c instanceof Ca)
                ...
                throw Error("Unexpected type when unwrapping SafeAttributePrefix, got '" + c + "' of type '" + typeof c + "'");
            return c
        }).every(function (c) {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var L = function (a, b, c) {
        ...
        , tb = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g
        , ub = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source, "g")
        ...
        , Cb = function (a, b) {
            ...
            if (e.nodeType === 1 && (b = e.tagName,
                ...
                throw d = b.toLowerCase() === "script" ? "Use safeScriptEl.setTextContent with a SafeScript." : "Use safeStyleEl.setTextContent with a SafeStyleSheet.",
                Error(d);
            if (a instanceof Va)
                a = a.ra;
            else
    ...
    var Fb = function (a, b, c, d) {
        if (C[c + "EventListener"])
            C[c + "EventListener"](a, b, !1);
        else if (C[d + "tachEvent"])
            C[d + "tachEvent"]("on" + a, b)
    }
        , Gb = function () {
            var a = D.readyState;
        ...
        , Ib = function (a) {
            if (Gb())
                ...
                C.addEventListener ? (C.addEventListener("load", c, !1),
                    C.addEventListener("DOMContentLoaded", c, !1)) : C.attachEvent && (C.attachEvent("onreadystatechange", function () {
    ...
    var Zb = /^(\/[a-zA-Z0-9_\-]+)+$/
        ...
        , gc = function (a, b, c, d, e) {
            ...
            try {
                ...
                if (e && e.length > 0) {
                    ...
                    for (d = {}; c < e.length;) {
                        var l = e[c++]
                            , m = ja(l) ? "o" + (Object.prototype.hasOwnProperty.call(l, ma) && l[ma] || (l[ma] = ++na)) : (typeof l).charAt(0) + l;
                        Object.prototype.hasOwnProperty.call(d, m) || (d[m] = !0,
                            e[b++] = l)
                    }
                    e.length = b;
                    h = h + "?le=" + e.join(",");
        ...
        , jc = function (a, b, c, d) {
            ...
            return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.ca ? "/am=" + e(a.ca) : "", a.ta ? "/rs=" + e(a.ta) : "", a.wa ? "/t=" + e(a.wa) : "", "/cb=", e(c)].join("")
        }
        , hc = function (a) {
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                ...
                f.length == 2 && g && k && (a[g] = a[g] || k)
            }
            b = "/" + c.join("/");
            Zb.test(b) || Q("invalid_prefix");
            c = 0;
            for (d = $b.length; c < d; ++c)
                $b[c].test(b) && Q("invalid_prefix");
            c = kc(a, "k", !0);
            d = kc(a, "am");
            e = kc(a, "rs");
            a = kc(a, "t");
    ...
    Yb.m = function (a, b, c, d) {
        ...
        ;
    var lc = decodeURI("%73cript"), mc = /^[-+_0-9\/A-Za-z]+={0,2}$/, nc = function (a, b) {
        ...
        var a = M.nonce;
        return a !== void 0 ? a && a === String(a) && a.match(mc) ? a : M.nonce = null : D.querySelector ? (a = D.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
            a && a === String(a) && a.match(mc) ? M.nonce = a : M.nonce = null) : null : null
    }, rc = function (a) {
    ...
    var R = function (a) {
        ...
        , T = function (a, b, c) {
            if (b && typeof b === "object")
                for (var d in b)
                    !Object.prototype.hasOwnProperty.call(b, d) || c && d === "___goc" && typeof b[d] === "undefined" || (a[d] && b[d] && typeof a[d] === "object" && typeof b[d] === "object" && !Bc(a[d]) && !Bc(b[d]) ? T(a[d], b[d]) : b[d] && typeof b[d] === "object" ? (a[d] = Bc(b[d]) ? [] : {},
                        T(a[d], b[d])) : a[d] = b[d])
        }
        , Ec = function (a, b) {
            if (a && !/^\s+$/.test(a)) {
                ...
                a = a.replace(RegExp("([^\"',{}\\s]+?)\\s*:\\s*(.*?)[,}\\s]", "g"), function (g, k, h) {
                    ...
                    h = h.endsWith('"') ? h.slice(0, -1) + "%DOUBLE_QUOTE%" : h;
        ...
        , Gc = function (a) {
            ...
            for (var g = 0; g < e.length; ++g)
                for (var k = e[g], h = 0; h < f.length; ++h)
                    k.src && k.src.indexOf(f[h]) == 0 && d.push(k);
    ...
    var Uc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//
        ...
        , Wc = function () {
            ...
            a == null && (b = window.location.href,
                a = L(b, "authuser") || null,
                a == null && (a = (a = b.match(Uc)) ? a[1] : null));
            if (a == null)
                return null;
            a = String(a);
            a.length > 254 && (a = null);
    ...
    var Yc, Zc, $c = void 0, X = function (a) {
        try {
        ...
        if (d !== "undefined") {
            ...
            b = [];
            var e = Y(a);
            if (a != null && typeof a.toJSON === "function" && (Object.prototype.hasOwnProperty.call(a, "toJSON") || (e !== fd || a.constructor !== Array && a.constructor !== Object) && (e !== ed || a.constructor !== Array && a.constructor !== Object) && e !== dd && e !== ad && e !== cd && e !== bd))
        ...
        if (Zc !== -1)
            return zd(),
                $c ? A.JSON.stringify.call(A.JSON, a) : gd(a)
    }, Cd = !Date.prototype.toISOString || typeof Date.prototype.toISOString !== "function" || (new Date(0)).toISOString() !== "1970-01-01T00:00:00.000Z", Dd = function () {
    ...
    var Md = function (a, b, c) {
        ...
        c = a.g[1];
        e = a.g[2];
        for (var f = a.g[3], g = a.g[4], k, h, l = 0; l < 80; l++)
            l < 40 ? l < 20 ? (k = f ^ c & (e ^ f),
                h = 1518500249) : (k = c ^ e ^ f,
                    h = 1859775393) : l < 60 ? (k = c & e | f & (c | e),
                        h = 2400959708) : (k = c ^ e ^ f,
                            h = 3395469782),
                k = (b << 5 | b >>> 27) + k + g + h + d[l] & 4294967295,
                g = f,
                f = e,
    ...
    Pd || (Td = (screen.width * screen.width + screen.height) * 1E6,
        Ud = Wd(D.cookie + "|" + D.location + "|" + (new Date).getTime() + "|" + Math.random()),
        Qd = W("random/maxObserveMousemove") || 0,
        Qd != 0 && Fb("mousemove", Vd, "add", "at"));
    var Xd = function () {
        var a = M.onl;
        if (!a) {
            a = F();
        ...
        , Yd = function (a, b) {
            b = b.onload;
            return typeof b === "function" ? (Xd().a(a, b),
                b) : null
        }
        , Zd = function (a) {
    ...
    var ae = {
        ...
        , ee = function (a, b, c, d, e) {
            ...
            try {
                ...
                f || (f = (a ? new db(cb(a)) : ua || (ua = new db)).createElement("IFRAME"),
                    g && (f.onload = function () {
                        f.onload = null;
                        g.call(this)
                    }
            ...
            for (var h in c)
                a = c[h],
                    h === "style" && typeof a === "object" ? H(a, f.style) : be[h] || f.setAttribute(h, String(a));
    ...
    var ke = function (a) {
        ...
        , le = function (a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = ke(e)) && e.match(/^https?:\/\/[\w\-_\.]+/i) != null)
                    return e
            }
        ...
        , re = function (a, b, c) {
            ...
            switch (a) {
                ...
                case "plusone":
                    ...
                    d = U();
                    g == null && d && (g = d.ecp,
                        g == null && (g = d.gwidget && d.gwidget.ecp));
                    f.ecp = g || void 0;
                    delete f.href;
                    break;
                case "signin":
            ...
            c = {};
            for (var l in f)
                G(f, l) && h.test(l) && (c[l.replace(h, "")] = f[l],
                    delete f[l]);
            l = U("iframes/" + a + "/params/si") == "q" ? f : c;
            h = Mc();
            for (var m in h)
                !G(h, m) || G(f, m) || G(c, m) || (l[m] = h[m]);
            m = [].concat(pe);
            (l = U("iframes/" + a + "/methods")) && typeof l === "object" && hb.test(l.push) && (m = m.concat(l));
            for (var n in b)
                G(b, n) && /^on/.test(n) && (a != "plus" || n != "onconnect") && (m.push(n),
                    delete f[n]);
            delete f.callback;
            c._methods = m.join(",");
            return Ab(e, f, c)
        ...
        , ue = function (a) {
            for (var b = F(), c = a.nodeName.toLowerCase().indexOf("g:") != 0, d = a.attributes.length, e = 0; e < d; e++) {
                var f = a.attributes[e]
                    , g = f.name
                    , k = f.value;
                ib.call(se, g) >= 0 || c && g.indexOf("data-") != 0 || k === "null" || "specified" in f && !f.specified || (c && (g = g.substr(5)),
                    b[g.toLowerCase()] = k)
            }
            a = a.style;
            ...
            Sc(function (b) {
                if (a !== b.id && b.state != 4 && b.type != "share") {
                    ...
                    if (f) {
                        var g = re(d, b, 0);
                        g ? (f = f.parentNode,
                            ve(e) !== ve(g) && (b.dontclear = !0,
                                b.rd = !0,
                                b.ri = !0,
                                b.type = d,
                                we(f, b),
                                (d = V[f.lastChild.id]) && (d.oid = c),
                                Tc(c, 4))) : delete V[c]
                    } else
                        delete V[c]
                }
    ...
    var Ra = ea(["data-"]), ye, ze, Ae, Be, Ce, De = /(?:^|\s)g-((\S)*)(?:$|\s)/, Ee = {
        plusone: !0,
        autocomplete: !0,
        profile: !0,
        signin: !0,
        ...
        , Ge = function (a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                var l = h.nodeName.toLowerCase()
                    , m = void 0;
                if (h.hasAttribute("data-gapiscan"))
                    k = null;
                else {
                    var n = l.indexOf("g:");
                ...
                k && (Ee[k] || g.nodeName.toLowerCase().indexOf("g:") == 0 || qb(ue(g)).length != 0) && (ab(g),
                    E(c, k, []).push(g))
            }
            if (b)
                for (var q in c)
            ...
            if (Ie(Ce || {}))
                for (var w in c) {
                    a = c[w];
                    v = 0;
                    for (b = a.length; v < b; v++)
                        a[v].removeAttribute("data-gapiscan");
                    Je(w)
                }
            else {
                d = [];
    ...
    var Je = function (a, b) {
        var c = Ob(a);
        b && c ? (c(b),
            (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : J.load(a, function () {
                var d = Ob(a)
                    , e = b && b.iframeNode
                    , f = b && b.userParams;
                e && d ? (d(b),
                    e.setAttribute("data-gapiattached", !0)) : (d = J[a].go,
            ...
            switch (Qe(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        g = b = k;
                        fe.test(b) && (g = W("iframes/" + g.substring(1) + "/url"),
                            I(!!g, "Unknown iframe url config for - " + b));
                        k = Cb(D, g.replace(ge, ie));
                        b = c.ownerDocument || D;
                        h = 0;
                        do
                            g = f.id || ["I", ce++, "_", (new Date).getTime()].join("");
                        while (b.getElementById(g) && ++h < 5);
                        ...
                        m = m || "";
                        !m && q && (q = L(b.location.href, "_gfid", "") || L(b.location.href, "id", ""),
                            m = L(b.location.href, "pfname", ""),
                            m = q ? m + "/" + q : "");
                        m || (q = Ad(L(b.location.href, "jcp", ""))) && typeof q == "object" && (m = (m = q.id) ? q.pfname + "/" + m : "");
                        n.pfname = m;
                        f.connectWithJsonParam && (q = {},
                            q.jcp = Bd(n),
                            n = q);
                        ...
                        if (!q) {
                            if (!(q = f.rpctoken)) {
                                ...
                                Hd.ma || (Hd.ma = new Hd);
                                Fd(w(Hd.ma, 50));
                                Pd ? (w = new C.Uint32Array(1),
                                    Od.getRandomValues(w),
                                    w = Number("0." + w[0])) : (w = Sd,
                                        w += parseInt(Ud.substr(0, 20), 16),
                                        Ud = Wd(Ud),
                                        w /= Td + 1.2089258196146292E24);
                                q = q(v.call(m, w * 1E8))
                            }
                            n.rpctoken = q
                        }
                        ...
                        if (h.forcePost || n && k.length > 2E3) {
                            ...
                            for (n = 0; n < l.length; n++)
                                q = l[n].split("=", 2),
                                    f.push([decodeURIComponent(q[0]), decodeURIComponent(q[1])]);
                            h.query = [];
                            l = yb(h);
        ...
        , we = function (a, b) {
            ...
            if (d) {
                ...
                Pc.log("gapi." + c + ".render: missing element " + typeof a === "string" ? a : "")
        };
    E(J, "platform", {}).go = He;
    Ie = function (a) {
            ...
            function d(f) {
                ...
                if (Xe(g, b)) {
                    ...
                    Ye(a, function () {
                        h && N("rqd");
                        c();
                        for (var l = E(M, "RPMQ", []), m = 0; m < l.length; m++)
                            l[m]({
                                data: g,
                                origin: k
                            })
                ...
                if (d.s === "_renderstart" || d.s === We + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1],
                        ...
                        a: {
                            ...
                            (d = c.nextSibling) && d.dataset && d.dataset.gapistub && (c.parentNode.removeChild(d),
                                c.style.cssText = "");
                            d = a.width;
                            var f = a.height
                                , g = c.style;
    ...
    var cf = window.location.protocol === "https:"
        ...
        , ff = function () {
            ...
            df.iterate(function (c, d) {
                c.indexOf("G_AUTHUSER_") === 0 && (c = ef(c.substring(11)),
                    !a || c.o && !a.o || c.o == a.o && c.B > a.B) && (a = c,
                        b = d)
            });
            return {
                Ba: a,
    ...
    p.va = function () {
        ...
        ;
    p.pa = function () {
        this.X && (this.fa() ? this.G = this.ba : this.G = Math.min((this.G || this.ba) * 2, 120),
            window.setTimeout(qa(this.pa, this), this.G * 1E3))
    }
        ;
    p.G = 0;
    p.ba = 2;
    ...
    window.gapi.load("", {
        callback: window["initGooglePlatform"],
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.6zM9SN8ON8Q.O/am=AAAg/d=1/rs=AHpOoo9LiInNUyZ6A99oK9HdmPXGee7Zyg/m=__features__",
